...
<td colspan="2" style="font-size:20px;color:blue">
 User Details</td></tr>
  ...
  <tr>
    <th>Reservation final status</th>
    <td><?php
    $reservationstatus=$row['Reservationfinalstatus'];
if($row['reservationfinalstatus']=="Reservation confirmed")
{
  echo"reservation confirmed";

}
if($row['reservationfinalstatus']=="Reservation delayed")
{
  echo" reservation delayed";
...
<tr>
  ...
  <tr>
    ...
    <td>
   <select name="status" class="form-control wd-450" required="true" >
     <option value="Reservation Confirmed" selected="true">Reservation Confirmed</option>
          <option value="Reservation delayed">Reservation delayed</option>
   </select></td>
  </tr>
    <tr align="center">
