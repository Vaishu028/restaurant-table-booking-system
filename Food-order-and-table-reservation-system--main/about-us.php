                ...
                <div class="page-title-wrapper text-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="page-title-inner">
                            ...
                            <span>Mighty Great Restaurant ordering system</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="about-feat text-center wow fadeIn" data-wow-delay="0.2s">
                                    ...
                                    <img src="assets/images/resource/1.jpg" alt="about-img.jpg" itemprop="image" width="100" height="400">
                                </div>
                                ...
                                <div class="title1-wrapper text-center style2">
                                    <div class="title1-inner">
                                        ...
                                        <p itemprop="description"><p>We offer food order service via online system, where one can track the the order using truck number.</p></p>
                                    </div>
                                </div>
